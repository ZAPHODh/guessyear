...
export function DailyStatsChart({ data, totalGames, userAttempt }: DailyStatsChartProps) {
  ...
  const chartConfig = {
    ...
    attempt1: {
      label: "Attempt 1",
      color: userAttempt === 1 ? "var(--chart-1)" : "var(--chart-2)",
    },
    attempt2: {
      label: "Attempt 2",
      color: userAttempt === 2 ? "var(--chart-1)" : "var(--chart-2)",
    },
    attempt3: {
      label: "Attempt 3",
      color: userAttempt === 3 ? "var(--chart-1)" : "var(--chart-2)",
    },
    attempt4: {
      label: "Attempt 4",
      color: userAttempt === 4 ? "var(--chart-1)" : "var(--chart-2)",
    },
    attempt5: {
      label: "Attempt 5",
      color: userAttempt === 5 ? "var(--chart-1)" : "var(--chart-2)",
    },
