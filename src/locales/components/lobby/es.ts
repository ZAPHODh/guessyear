export default {
  ...
  room: {
    ...
    setProfileLoggedIn: "Por favor, establece tu nombre para mostrar para unirte al lobby",
    setProfileAnonymous: "Por favor, establece tu nombre para mostrar para unirte al lobby",
