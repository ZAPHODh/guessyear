export default {
  ...
  room: {
    ...
    // Profile setup
    setProfile: "Configure Seu Perfil",
    setProfileLoggedIn: "Por favor, defina seu nome de exibição para entrar no lobby",
    setProfileAnonymous: "Por favor, defina seu nome de exibição para entrar no lobby",
