export default {
  ...
  objective: {
    title: "Objective",
    description: "Guess the year when a photograph was taken. You have 5 attempts to get it right!"
  },
  howItWorks: {
    title: "How It Works",
    step1: "Look at the photograph carefully for clues about the time period.",
